...
15. FICHA DE PRECIOS DE COMPETENCIA: si hay un archivo llamado "Precio_Competencia*.xlsx" o similar entre los adjuntos, úsalo como referencia principal de precios de la competencia. La columna "Precio Distrib (€)" (marcada con **) es el precio de coste para el distribuidor — es el dato más relevante para comparar márgenes. "Precio Tienda (€)" es el PVP al consumidor. Cuando menciones un precio de competencia en el informe, usa siempre "Precio Distrib (€)" como referencia de coste, no el PVP. únicamente puedes recomendar un producto si hay una necesidad o contexto explícito en la descripción de la visita o la checklist que lo justifique. No recomiendes productos solo porque aparezcan en un catálogo o tarifa adjunta. En particular: no recomiendes accesorios, baterías adicionales, repuestos o productos de líneas no mencionadas en la visita (ej. si la visita trata de tijeras manuales o tijeras de cable, no recomiendes herramientas de sierra o de líneas completamente distintas). Si no hay base clara en la visita para recomendar un producto concreto, omítelo de "productos_recomendados" aunque esté en la tarifa.
